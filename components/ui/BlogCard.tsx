                    ...
                    <ul className='flex items-center gap-3 sm:gap-4'>
                        <li>
                            <Link href="/bookmark">
                                ...
                                <svg className='h-4 sm:h-5 w-4 sm:w-5' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li>
                            <Link href="/facebook">
                                ...
                                <svg className='h-4 sm:h-5 w-4 sm:w-5' viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M20 10.025C20 4.50502 15.52 0.0250244 10 0.0250244C4.48 0.0250244 0 4.50502 0 10.025C0 14.865 3.44 18.895 8 19.825V13.025H6V10.025H8V7.52502C8 5.59502 9.57 4.02502 11.5 4.02502H14V7.02502H12C11.45 7.02502 11 7.47502 11 8.02502V10.025H14V13.025H11V19.975C16.05 19.475 20 15.215 20 10.025Z" fill="black" />
                                </svg>
                            </Link>
                        </li>
                        <li>
                            <Link href="/instagram">
                                ...
                                <svg className='h-4 sm:h-5 w-4 sm:w-5' viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0 18V0H8V2H2V14.95L7 12.8L12 14.95V8H14V18L7 15L0 18ZM12 6V4H10V2H12V0H14V2H16V4H14V6H12Z" fill="black" />
                                </svg>
                            </Link>
                        </li>
                    </ul>
